...
const Page = () => {
  return (
    <div>
        ...
        <div className='bg-[#fff9e8] px-[20px] md:px-[80px] py-[60px]'>
            <div className='flex flex-col items-center'>
            ...
            <div className='mt-[20px] flex flex-col gap-[12px]'>
                ...
                <p className='text-[16px] text-[#050123]'>HƏRRAC.ORG-un hekayəsini danışarkən sizi onun açılan fəsillərinin bir hissəsi olmağa dəvət edirik. Hər təklifin bir nağıl danışdığı və hər auksionun yeni macəra üçün fürsət olduğu bu həyəcanverici səyahətdə bizə qoşulun.</p>
                <p className='text-[16px] text-[#050123] mt-[30px]'>Hekayəmizin bir hissəsi olduğunuz üçün təşəkkür edirik. Hərracların təcrübəyə çevrildiyi və hər anın gələcəyə doğru bir təklif olduğu HƏRRAC.ORG-a təkrar xoş gəlmisiniz.</p>
            </div>
        </div>
        <div className='mt-[100px] mb-[120px] px-[20px] md:px-[80px] flex flex-col items-center'>
